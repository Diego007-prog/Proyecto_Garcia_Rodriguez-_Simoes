...
from api import api_buscar_obras_por_departmento, api_buscar_obras_por_nombre, api_buscar_obras_por_id, api_obras
...
class Museo :
    ...
    def opcion_2(self, obras):
        ...
        #pide al usuario que seleccione una nacionalidad
        ...
        #filtra las obras por la nacionalidad seleccionada
        for obra in obras:
            if obra.nacionalidad_artista.lower() == nacionalidad_seleccionada.lower():
                obra.show()
